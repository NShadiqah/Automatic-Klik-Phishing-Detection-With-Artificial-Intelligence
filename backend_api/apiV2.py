...
Perubahan dari versi sebelumnya:
  - Path model tidak lagi hardcoded ke ../../Phising — pakai BASE_DIR
  - Nama file model disesuaikan: model.pkl / feature_cols.pkl
  - Threshold disimpan di config, bukan file pkl terpisah
  - Safe domain override tidak lagi manipulasi probabilitas model secara diam-diam
    → sekarang transparan via flag overridden_by_safelist di response
  - Bare except diganti logging.exception
  - Validasi URL diperkuat (panjang, karakter, scheme)
  - Rate limiting via Flask-Limiter
  - CORS dikonfigurasi via env var ALLOWED_ORIGINS
  - Logging request/response ditambahkan
  - Endpoint /health diperkaya dengan info model
"""
